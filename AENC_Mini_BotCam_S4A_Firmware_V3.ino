...
void updateActuator(byte pinNumber)
{
  ...
  else if (pinNumber == 12) digitalWrite(7, arduinoPins[pinNumber].state);
  else if (pinNumber == 13) digitalWrite(10, arduinoPins[pinNumber].state);
  else{
